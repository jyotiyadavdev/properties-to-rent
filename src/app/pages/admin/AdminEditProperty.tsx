...
import { getPropertyById, adminUpdateProperty } from '../../utils/api';
...
export default function AdminEditProperty() {
  ...
  // Static properties data for edit
  const staticProperties: any = {
    '1': {
      ...
      features: ['Parking', 'Lift', '24/7 Security', 'Power Backup', 'Gym'],
      agentName: 'Ramesh Sharma',
      agentContact: '+91 9876543210',
      agentEmail: 'ramesh@realestate.com',
      status: 'active',
      featured: true,
    ...
    '2': {
      ...
      constructionStatus: 'Ready to move',
      preferredTenant: 'All',
      features: ['Swimming Pool', 'Garden', 'Parking', '24/7 Security', 'Power Backup'],
    ...
    '3': {
      ...
      features: ['Parking', 'Lift', '24/7 Security', 'Power Backup', 'CCTV Surveillance'],
      agentName: 'Amit Kumar',
      agentContact: '+91 9876543212',
      agentEmail: 'amit@realestate.com',
      status: 'active',
      featured: false,
  ...
  const loadProperty = async () => {
    ...
    try {
      ...
      const property = staticProperties[id!];
      ...
      setFurnishedType(property.furnishedType || 'Fully Furnished');
      setConstructionStatus(property.constructionStatus || 'Ready to move');
      setPreferredTenant(property.preferredTenant || 'All');
      ...
      setThumbnailUrl(property.thumbnailImage || '');
    } catch (error) {
  ...
  const handleThumbnailUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // In real scenario, call uploadPropertyImage API
      setThumbnailUrl('https://via.placeholder.com/200');
    } catch (error: any) {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>, index: number) => {
    ...
    try {
      ...
      // In real scenario, call uploadPropertyImage API
      updateImageUrl(index, 'https://via.placeholder.com/800');
    } catch (error: any) {
    ...
    <AdminLayout>
      <div className="p-6 lg:p-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-[#002b5b]">Edit Property</h1>
          <p className="text-gray-600 mt-1">Update property details</p>
        </div>

        <form onSubmit={handleSubmit} className="max-w-4xl">
          {/* Same form as Add Property - just pre-filled */}
